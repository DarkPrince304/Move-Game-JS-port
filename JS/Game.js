...
Crafty.background("url('Images/titlescreen.png')");
		...
		if(number==1)
		Level = [ [2,0,1], [2,0,1], [2,0,1] ]; //1
		else if(number==2)
		Level = [ [1,4,1], [0,3,0], [2,0,2] ]; //2
		else if(number==3)
		Level = [ [3,1,3], [4,1,3], [2,2,0] ]; //3
		else if(number==4)
		Level = [ [3,3,3], [0,2,4], [0,4,1] ]; //20
		else if(number==5)
		Level = [ [4,2,0], [4,0,3], [1,3,0] ];
		else if(number==6)
		Level = [ [1,3,1], [1,2,0], [2,2,3] ]; //26
		else if(number==7)
		Level = [ [2,0,3], [2,2,3], [1,1,1] ]; //31
		else if(number==8)
		Level = [ [0,0,1], [0,2,4], [3,3,4] ]; //36
		else if(number==9)
		Level = [ [4,1,3], [4,3,2], [0,0,0] ]; //41
		else if(number==10)
		Level = [ [1,4,1], [3,2,3], [0,2,0] ]; //46
		else if(number==11)
		Level = [ [4,2,3], [1,0,2], [1,0,3] ]; //30
		else if(number==12)
		Level = [ [4,4,1], [3,2,0], [0,0,3] ]; //35
		else if(number==13)
		Level = [ [2,1,1], [2,3,1], [2,3,3] ]; //40
		else if(number==14)
		Level = [ [0,2,1], [2,3,4], [0,3,1] ]; //45
		else if(number==15)
		Level = [ [1,1,2], [1,3,2], [3,0,2] ]; //50
		else if(number==16)
		...
		Level = [ [0,4,4], [3,0,1], [2,0,3] ]; //57
		else if(number==20)
		Level = [ [2,3,3], [2,0,0], [4,1,1] ]; //63
